...
func (r *UIReconciler) reconcileUIService(ctx context.Context, pulse *pulsev1alpha1.OpenShiftPulse) error {
	...
	desired := &corev1.Service{
		ObjectMeta: metav1.ObjectMeta{
			...
			Annotations: map[string]string{
				// Tells OCP to generate a serving certificate into tlsSecretName.
	...
	// Preserve existing annotations to avoid dropping the serving-cert annotation.
